const generateResponseMail = (info) => { 
    return `<!doctype html>
...
<body data-new-gr-c-s-loaded="14.1078.0">
...
<tr>
<td align="center"><p style="direction: rtl; font-size: 22px;font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif"><strong>שלום ${info.requesterFirstName},</strong></p><p style="font-size: 22px;font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif"><br></p><p style="direction: rtl; font-size: 22px;font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif">
בקשת ההרשמה עבור התלמיד ${info.studentFirstName} ${info.studentLastName} נקלטה בהצלחה! במהלך הימים הקרובים תשלח אליך תשובה בדבר קבלתו של התלמיד לתוכנית.
</p><p style="font-size: 22px;font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif"><br></p><p style="font-size: 18px;font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif">.אנו מודים לך על הבעת ההתעניינות בתוכנית שביטים&nbsp;ומאחלים בהצלחה<br></p><p style="font-size: 18px;font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif"><br><br><strong>,בברכה</strong><strong></strong><br></p></td>
</tr>
<tr>
<td align="center" height="16"></td>
</tr>
<tr>
<td align="center"><p style="font-size: 30px;font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;color: #4240ea">שביטים</p></td>
</tr>
<tr>
<td align="center" class="es-p10"><p style="font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size: 20px">תוכנית הכנה ליחידות הסייבר<br> ולתעשיית ההייטק עבור תלמידי תיכון מצטיינים</p></td>
</tr>
</table></td>
</tr>
</table></td>
